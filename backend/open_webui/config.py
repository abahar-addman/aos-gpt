...
ENABLE_LANGGRAPH_AGENT = os.getenv('ENABLE_LANGGRAPH_AGENT', 'False').lower() == 'true'
...
AZURE_PIPELINE_CONTAINER_NAME = os.getenv('AZURE_PIPELINE_CONTAINER_NAME', 'aos-pipeline')
...
if ENV == 'prod':
    if OLLAMA_BASE_URL == '/ollama' and not K8S_FLAG:
        if USE_OLLAMA_DOCKER.lower() == 'true':
            # if you use all-in-one docker container (Edison AI + Ollama)
...
OLM_OCR_API_BASE_URL = os.getenv('OLM_OCR_API_BASE_URL', OLLAMA_BASE_URL)

OLM_OCR_MODEL = os.getenv('OLM_OCR_MODEL', 'richardyoung/olmocr2:7b-q8')
...
DEFAULT_CONFIG = {
    ...
    'rag.OLM_OCR_API_BASE_URL': OLM_OCR_API_BASE_URL,
    'rag.OLM_OCR_MODEL': OLM_OCR_MODEL,
    ...
    'langgraph.enable': ENABLE_LANGGRAPH_AGENT,
