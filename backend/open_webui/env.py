...
# Must be resolved before logging.basicConfig() below, which reads it.
...
WEBUI_NAME = os.getenv('WEBUI_NAME', 'Edison AI')
...
LANGGRAPH_AGENT_MAX_ITERATIONS = int(os.environ.get('LANGGRAPH_AGENT_MAX_ITERATIONS', '10'))
LANGGRAPH_AGENT_THINKING_DEPTH = int(os.environ.get('LANGGRAPH_AGENT_THINKING_DEPTH', '3'))
LANGGRAPH_AGENT_ANALYSIS_TRUNCATION = int(os.environ.get('LANGGRAPH_AGENT_ANALYSIS_TRUNCATION', '2000'))
