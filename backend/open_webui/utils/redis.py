...
def get_redis_connection(
    ...
    if redis_sentinels:
        ...
        # Fork fast-fail defaults: bound connect/read timeouts (5s fallback when
        # REDIS_SOCKET_CONNECT_TIMEOUT is unset) and disable retry-on-timeout so a
        # dead Redis surfaces immediately instead of hanging requests.
        _timeout = REDIS_SOCKET_CONNECT_TIMEOUT or 5
        standalone_opts = {
            **extra,
        ...
        connection = factory(redis_url, decode_responses=decode_responses, **standalone_opts)
